...
<div id="footer" class="d-lg-flex justify-content-lg-start align-items-lg-center p-2 text-center text-lg-left mt-auto bg-body border-top" style="font-size: 11px;">
    <div class="mb-3 me-lg-5 mb-lg-0 text-muted">
        <!-- cassien fork: GPL-3.0 legal notice kept; vendor marketing links removed. -->
        Easy!Appointments v<?= config('version') ?> &middot; GPL-3.0 &middot;
        <a href="https://github.com/99INFLUENCERS/easyappointments" target="_blank" rel="noopener">cod sursă</a>
    </div>
